...
//    private static final Map<UUID, CpcUser> userMap = new ConcurrentHashMap<>();
//    private static final Map<UUID, SocketIOClient> clientMap = new ConcurrentHashMap<>();
//    public static void saveClient(UUID sessionId, SocketIOClient socketIOClient, CpcUser user) {
...
//    }
//    public static Map<UUID, CpcUser> getUserMap() {
//        return userMap;
//    }
//    // 推送消息
